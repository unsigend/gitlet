...
def test_dir_and_file_create() -> None:
    ...
    assert result.stdout == f"Initialized empty gitlet repository in {os.getcwd()}\n"
    ...
    # TODO: after finish the implementation of the command "gitlet init" uncomment the following code
